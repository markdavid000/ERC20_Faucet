      ...
      (entries) => {
        entries.forEach((e) => {
          if (e.isIntersecting) {
            ...
            const link = NAV_LINKS.find((l) => l.href === `#${id}` || (id === "" && l.label === "Hero"));
              ...
              >
                ...
                <span
                  className={[
                    ...
                    activeSection === link.label ? "w-full" : "w-0 group-hover:w-full",
                  ].join(" ")}
                />
              </a>
            ))}
              ...
              {NAV_LINKS.map((link, i) => (
                <motion.a
                  ...
                  className={[
                    ...
                    activeSection === link.label ? "text-primary" : "text-slate-400",
                  ].join(" ")}
                >
                  {link.label}
                </motion.a>
              ...
              <div className="pt-2">
                {isConnected && address ? (
                  <div className="space-y-2">
                    <p className="text-xs text-on-surface-variant font-body">{shortenAddress(address, 8)}</p>
                    <Button variant="danger" size="sm" leftIcon={<LogOut className="w-3.5 h-3.5" />} onClick={disconnect}>
                      Disconnect
                    </Button>
                  </div>
                ) : (
